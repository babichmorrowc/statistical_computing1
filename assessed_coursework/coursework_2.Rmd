...
In this assessed coursework, I use profiling to identify inefficiencies in the `tune` function of the `e1071` package, particularly focusing on its application to tune support vector machines. The coursework primarily focuses on profiling and parallelisation, as well as the use of vectorisation to improve performance.
...
abalone_tuned_svm_optmised$best.parameters
```
...
To improve performance further, we can ap
